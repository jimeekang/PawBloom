...
export function buildMedicationReminderRequests({ petName, schedules, fromDate, daysAhead }: { petName: string; schedules: CareMedicationSchedule[]; fromDate: string; daysAhead: number }) {
