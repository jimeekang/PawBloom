...
export const styles = StyleSheet.create({
  ...
  givenButton: { flex: 1, minHeight: 44, borderRadius: radius.md, backgroundColor: colors.mintDeep, alignItems: "center", justifyContent: "center" },
  givenButtonText: { ...type.caption, color: colors.white, fontWeight: "600" },
  partialButton: { flex: 1, minHeight: 44, borderRadius: radius.md, borderWidth: 1, borderColor: colors.segmentActiveBorder, backgroundColor: colors.surfacePeach, alignItems: "center", justifyContent: "center" },
  partialButtonText: { ...type.caption, color: colors.orangeDeep, fontWeight: "600" },
  skipButton: { flex: 1, minHeight: 44, borderRadius: radius.md, borderWidth: 1, borderColor: colors.border, alignItems: "center", justifyContent: "center" },
  skipButtonText: { ...type.caption, color: colors.textMuted, fontWeight: "600" },
  agendaActionSelected: { borderWidth: 2, borderColor: colors.orangeDeep },
