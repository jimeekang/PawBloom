...
import { scheduleAppliesOnDate } from "../application/medicationScheduleRules";
...
export function createTodayMedicationAgendaRows({ schedules, doses, doseDate }: { schedules: MedicationSchedule[]; doses: DoseRecord[]; doseDate: string }): TodayMedicationAgendaRow[] {
