...
> 상세 일정(주차별 Day-by-Day, Task 단위, 하루 리듬)은 [0003](./0003-mvp-schedule.md)로 위임한다. 이 문서는 PM 로드맵 서술(방향/우선순위/마일스톤 개요)만 유지한다.
...
상세 Day-by-Day 일정, 담당 role, 산출물, Task 단위 파일 목록은 [0003](./0003-mvp-schedule.md)에 있다.
