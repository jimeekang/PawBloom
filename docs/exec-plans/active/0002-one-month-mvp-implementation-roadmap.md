...
30일 안에 PetBloom의 테스트 가능한 MVP를 만든다.
...
| P1 | Family/caregiver role | PetBloom 차별화의 핵심인 공동 기록에 필요하다. | owner/family 권한 분리 |
...
- `apps/mobile/src/presentation/PetBloomShell.tsx`
