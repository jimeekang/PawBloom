...
PawBloom는 이중 언어 반려동물 다이어리와 케어 기록 앱이다. 평소에는 보호자가 일상 기록을 빠르게 남기도록 돕고, 반려동물이 아플 때는 Care Mode로 전환해 병원에 가져갈 수 있는 기록 기반 briefing을 만든다.
...
3. 기본 루틴과 care plan 대비 오늘 달라진 점을 기록으로 남긴다.
...
- 약 일정과 투약 상태 기록
- 기본 루틴은 Diary 오늘 기록에, care plan은 Care Mode 오늘 투약/케어 기록에 불러오고, 사용자는 오늘 실제 값만 수정
